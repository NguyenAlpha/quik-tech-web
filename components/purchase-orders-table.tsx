...
export function PurchaseOrdersTable({
  ...
  const getStatusBadge = (status: string) => {
    ...
    return {
      className: statusMap[status] ?? 'bg-gray-100 text-gray-600',
      label: displayMap[status] ?? status,
    }
  }
            ...
            return (
              <>
                <TableRow key={po.id} className="group">
                  ...
                  <TableCell>
                    <span className="font-mono text-sm text-muted-foreground">{po.supplierPublicId}</span>
                  </TableCell>
                  <TableCell>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <div className="space-y-2 text-sm">
                            {po.items.map((item, idx) => (
                              <div key={`${item.productPublicId}-${idx}`} className="flex justify-between items-center">
                        ...
                        {po.note && (
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">{po.note}</p>
                          </div>
                        )}
                      </div>
                    </TableCell>
